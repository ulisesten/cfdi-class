...
namespace CFD_33
{
  ...
  void Comprobante::
  CfdiRelacionados (::std::unique_ptr< CfdiRelacionados_type > x)
  {
    this->CfdiRelacionados_.set (std::move (x));
  }
  ...
  void Concepto::
  CuentaPredial (::std::unique_ptr< CuentaPredial_type > x)
  {
    this->CuentaPredial_.set (std::move (x));
  }
...
namespace CFD_33
{
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_content (); p.next_content (false))
    {
      ...
      // CfdiRelacionados
      //
      if (n.name () == "CfdiRelacionados" && n.namespace_ () == "http://www.sat.gob.mx/cfd/3")
      {
        ...
        {
          this->CfdiRelacionados_.set (::std::move (r));
          continue;
        }
      }
      ...
      // Emisor
      //
      if (n.name () == "Emisor" && n.namespace_ () == "http://www.sat.gob.mx/cfd/3")
      {
      ...
      // Receptor
      //
      if (n.name () == "Receptor" && n.namespace_ () == "http://www.sat.gob.mx/cfd/3")
      {
      ...
      // Conceptos
      //
      if (n.name () == "Conceptos" && n.namespace_ () == "http://www.sat.gob.mx/cfd/3")
      {
      ...
      // Impuestos
      //
      if (n.name () == "Impuestos" && n.namespace_ () == "http://www.sat.gob.mx/cfd/3")
      {
      ...
      // Complemento
      //
      if (n.name () == "Complemento" && n.namespace_ () == "http://www.sat.gob.mx/cfd/3")
      {
        ::std::unique_ptr< Complemento_type > r (
          Complemento_traits::create (i, f, this));

        this->Complemento_.push_back (::std::move (r));
        continue;
      }

      // Addenda
      //
      if (n.name () == "Addenda" && n.namespace_ () == "http://www.sat.gob.mx/cfd/3")
      {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_content (); p.next_content (false))
    {
      ...
      // CfdiRelacionado
      //
      if (n.name () == "CfdiRelacionado" && n.namespace_ () == "http://www.sat.gob.mx/cfd/3")
      {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_content (); p.next_content (false))
    {
      ...
      // Concepto
      //
      if (n.name () == "Concepto" && n.namespace_ () == "http://www.sat.gob.mx/cfd/3")
      {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_content (); p.next_content (false))
    {
      ...
      // Retenciones
      //
      if (n.name () == "Retenciones" && n.namespace_ () == "http://www.sat.gob.mx/cfd/3")
      {
      ...
      // Traslados
      //
      if (n.name () == "Traslados" && n.namespace_ () == "http://www.sat.gob.mx/cfd/3")
      {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_content (); p.next_content (false))
    {
      ...
      // InformacionAduanera
      //
      if (n.name () == "InformacionAduanera" && n.namespace_ () == "http://www.sat.gob.mx/cfd/3")
      {
      ...
      // CuentaPredial
      //
      if (n.name () == "CuentaPredial" && n.namespace_ () == "http://www.sat.gob.mx/cfd/3")
      {
        ...
        {
          this->CuentaPredial_.set (::std::move (r));
          continue;
        }
      }
      ...
      // ComplementoConcepto
      //
      if (n.name () == "ComplementoConcepto" && n.namespace_ () == "http://www.sat.gob.mx/cfd/3")
      {
      ...
      // Parte
      //
      if (n.name () == "Parte" && n.namespace_ () == "http://www.sat.gob.mx/cfd/3")
      {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_content (); p.next_content (false))
    {
      ...
      // Retencion
      //
      if (n.name () == "Retencion" && n.namespace_ () == "http://www.sat.gob.mx/cfd/3")
      {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_content (); p.next_content (false))
    {
      ...
      // Traslado
      //
      if (n.name () == "Traslado" && n.namespace_ () == "http://www.sat.gob.mx/cfd/3")
      {
...
namespace CFD_33
{
                ...
                const ::xml_schema::properties& p)
  {
    ...
    return ::std::unique_ptr< ::CFD_33::Comprobante > (
      ::CFD_33::Comprobante_ (
                ...
                const ::xml_schema::properties& p)
  {
    ...
    return ::CFD_33::Comprobante_ (isrc, f, p);
  }
                ...
                const ::xml_schema::properties& p)
  {
    ...
    ::xsd::cxx::xml::sax::std_input_source isrc (is);
    return ::CFD_33::Comprobante_ (isrc, h, f, p);
  }
                ...
                const ::xml_schema::properties& p)
  {
    ...
    if (n.name () == "Comprobante" &&
        n.namespace_ () == "http://www.sat.gob.mx/cfd/3")
    {
      ::std::unique_ptr< ::CFD_33::Comprobante > r (
        ::xsd::cxx::tree::traits< ::CFD_33::Comprobante, char >::create (
          e, f, 0));
      return r;
    }
...
namespace CFD_33
{
  ...
  Comprobante_ (const ::CFD_33::Comprobante& s,
                const ::xml_schema::namespace_infomap& m,
                ::xml_schema::flags f)
  {
    ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d (
